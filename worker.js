...
async function handleCommand(env, chatId, text) {
  ...
  if (text === '/start' || text === '/help') {
    return { text: [
      ...
      '',
      '<b>Разделы:</b>',
      '/newsec Название — создать раздел. Важно! чтобы создать раздел нужно скопировать команду и добавить название раздела, иначе выдаст ошибку',
      '/secs — список разделов',
      '/mv N Раздел — перенести задачу: также при отсутствии номера раздела выдаст ошибку',
      '',
